...
function generateHash(activityId, timestamp, userId) {
    // 反转 activityId
    ...
    const params = {
        ...
        sellerId: storeId !== null ? storeId.toString() : null,
        timestamp: timestamp,
        userId: userId
    };
    ...
    const finalQueryString = `${queryString}&key=${reversedActivityId}`;

    // 生成 MD5 哈希
    const md5Hash = crypto.createHash('md5').update(finalQueryString).digest('hex').toUpperCase();
...
class _0x5026b8 extends _0x4c79d9 {
    ...
    async ["takePartInSign"](_0x358d5a = {}) {
        try {
            ...
            const signature = generateHash('947079313798000641', timestamp, uid)
            const _0xce18e9 = { "activityId": "947079313798000641", "storeId": 49006, "timestamp": timestamp, "signature": signature, "appid": "wxafec6f8422cb357b", "store_id": 49006 };
            const _0x1134c5 = {
                fn: "takePartInSign",
                method: "post",
